            ...
            <div class="overlay-container">
              <div class="overlay">
                ...
                <div class="overlay-panel overlay-left">
                  ...
                  <p>{{t("Let's create a collection together, give it a name and if you wish, insert an image")}}</p>
                </div>
              </div>
            </div>
          </div>
...
const onAdvancedUpload = () => {
  toast.add({ severity: 'info', summary: 'Success', detail: t('File Uploaded'), life: 3000 });
};
